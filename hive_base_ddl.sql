...
STORED AS TEXTFILE
LOCATION '/user/w205/hospital_compare/HQI_HOSP';
...
STORED AS TEXTFILE
LOCATION '/user/w205/hospital_compare/HQI_HOSP_HCAHPS';
...
STORED AS TEXTFILE
LOCATION '/user/w205/hospital_compare/HQI_HOSPITAL_COMP';
...
STORED AS TEXTFILE
LOCATION '/user/w205/hospital_compare/HQI_OP_Procedure_Volume';
